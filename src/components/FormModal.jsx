...
const FormModal = ({ isOpen, closeModal, updateInfo, userData }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setBloodPressureSystolic(userData.bloodPressure?.systolic || "");
      setBloodPressureDiastolic(userData.bloodPressure?.diastolic || "");
      setBloodSugarValue(userData.bloodSugar?.value || "");
      setBloodSugarUnit(userData.bloodSugar?.unit || "");
    }
  }, [isOpen, userData]);
