    ...
    <div className="h-full px-40 py-8">
      ...
      <div className="flex">
        ...
        <div className="p-10 w-1/2 flex flex-col gap-4 items-start">
          ...
          <p>
            Welcome to our AI Healthcare, where cutting-edge technology meets
            compassionate care. We harness the power of artificial intelligence
            to revolutionize healthcare, ensuring personalized solutions and
            improved patient outcomes. Join us on the forefront of innovation,
